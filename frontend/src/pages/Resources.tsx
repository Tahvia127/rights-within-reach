...
const FEATURED: ResourceCard[] = [
  ...
  },
  {
    ...
    tag: 'Featured',
    meta: ['★ 312-738-9200', '✦ Mon–Fri (to 7:30 Mon/Wed)'],
    href: 'tel:3127389200',
    featured: true,
  },
  {
    ...
    tag: 'Start here',
    meta: ['★ 855-956-5763', '✦ Mon–Fri, 9–4:30'],
    href: 'tel:8559565763',
    featured: true,
  },
]
...
const HOUSING: ResourceCard[] = [
  ...
  { name: 'Metropolitan Tenants Organization (MTO)', desc: 'Free tenants’ rights hotline for Chicago renters. Bilingual counselors explain your rights and help with repairs, evictions, lockouts, and unsafe conditions. Voicemail accepted 24/7.', tag: 'Chicago', meta: ['★ 773-292-4988', '✦ Mon–Fri, 1–5pm'], href: 'tel:7732924988' },
  { name: 'Illinois Court Help', desc: 'Free statewide guide to the court process — eviction steps, fee waivers, and e-filing. They explain what to do (not legal advice) and connect you to local help. Call or text.', tag: 'Court', meta: ['★ 833-411-1121', '✦ Mon–Fri, 9–2'], href: 'tel:8334111121' },
...
const MONEY: ResourceCard[] = [
  ...
  { name: 'Citizens Utility Board (CUB)', desc: 'Free nonprofit watchdog for Illinois utility customers. They review your electric, gas, and phone bills for savings and explain your shut-off protections. Advice only, no bill payments.', tag: 'Utility', meta: ['★ 1-800-669-5556', '✦ Mon–Fri, 9–4'], href: 'tel:18006695556' },
  { name: 'Catholic Charities (Chicago)', desc: 'Emergency rent and utility help, shelter, and crisis assistance for people of any faith across Cook and Lake Counties. Call to ask what is available near you.', tag: 'Emergency', meta: ['★ 312-655-7500', '✦ Crisis help'], href: 'tel:3126557500' },
...
const BENEFITS: ResourceCard[] = [
  ...
  { name: 'Center for Disability & Elder Law (CDEL)', desc: 'Free legal help for low-income older adults and people with disabilities in Cook County — housing stability, financial matters, guardianship, and benefits.', tag: 'Seniors', meta: ['★ 312-376-1880', '✦ Mon–Fri, 9–12'], href: 'tel:3123761880' },
...
const COURT: ResourceCard[] = [
  { name: 'Illinois Free Legal Answers', desc: 'Post a civil legal question online and get a free answer from a volunteer Illinois attorney. For income-eligible people who do not have a lawyer.', tag: 'Self-help', meta: ['★ illinois.freelegalanswers.org', '✦ Free · online'], href: 'https://illinois.freelegalanswers.org' },
...
const VETERANS: ResourceCard[] = [
  { name: 'Veterans Assistance Commission of Cook County', desc: 'Emergency help with rent, mortgage, utilities, food, and transportation for Cook County veterans, plus free officers who file VA claims and appeals.', tag: 'Cook County', meta: ['★ vaccookcounty.org', '✦ Mon–Fri 8:30–3'] },
  { name: "Illinois Dept. of Veterans' Affairs (IDVA)", desc: 'Statewide veteran services, benefits-claim help, DD-214 records, and long-term care homes. Cook County office plus offices statewide.', tag: 'Statewide', meta: ['★ 312-564-2322', '✦ veterans.illinois.gov'], href: 'tel:3125642322' },
...
const DESC_I18N: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'Administers EHRP, the Roof and Porch Program, and the Chicago Home Repair Program. Income-based eligibility.': 'Administra EHRP, el Programa de Techo y Porche, y el Programa de Reparación del Hogar de Chicago. Elegibilidad según ingresos.',
  ...
  zh: {
    ...
    'Administers EHRP, the Roof and Porch Program, and the Chicago Home Repair Program. Income-based eligibility.': '管理 EHRP、屋顶与门廊项目，以及芝加哥房屋维修项目。按收入决定资格。',
  ...
  tl: {
    ...
    'Administers EHRP, the Roof and Porch Program, and the Chicago Home Repair Program. Income-based eligibility.': 'Namamahala ng EHRP, ng Roof and Porch Program, at ng Chicago Home Repair Program. Pagiging karapat-dapat batay sa kita.',
  ...
  vi: {
    ...
    'Administers EHRP, the Roof and Porch Program, and the Chicago Home Repair Program. Income-based eligibility.': 'Quản lý EHRP, Chương trình Mái và Hiên nhà, và Chương trình Sửa chữa Nhà Chicago. Điều kiện theo thu nhập.',
  ...
  return (
    <>
      ...
      <main id="main">
        ...
        <section className="res-section" aria-labelledby="housing-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.housing.eyebrow')}</p>
            <h2 id="housing-orgs" className="serif res-cat-title">{t('res.cat.housing.title')}</h2>
            <ReadAloud id="res-housing" />
            <div className="res-grid">
        ...
        <section className="res-section" aria-labelledby="money-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.money.eyebrow')}</p>
            <h2 id="money-orgs" className="serif res-cat-title">{t('res.cat.money.title')}</h2>
            <ReadAloud id="res-money" />
            <div className="res-grid">
        ...
        <section className="res-section" aria-labelledby="repair-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.repairs.eyebrow')}</p>
            <h2 id="repair-orgs" className="serif res-cat-title">{t('res.cat.repairs.title')}</h2>
            <ReadAloud id="res-repair" />
            <div className="res-grid">
        ...
        <section className="res-section" aria-labelledby="benefits-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.benefits.eyebrow')}</p>
            <h2 id="benefits-orgs" className="serif res-cat-title">{t('res.cat.benefits.title')}</h2>
            <ReadAloud id="res-benefits" />
            <div className="res-grid">
        ...
        <section className="res-section" aria-labelledby="court-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.court.eyebrow')}</p>
            <h2 id="court-orgs" className="serif res-cat-title">{t('res.cat.court.title')}</h2>
            <ReadAloud id="res-court" />
            <div className="res-grid">
              {COURT.map((c, i) => <ResCard key={i} card={c} />)}
            </div>
          </div>
        </section>

        <section className="res-section" aria-labelledby="safety-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.safety.eyebrow')}</p>
            <h2 id="safety-orgs" className="serif res-cat-title">{t('res.cat.safety.title')}</h2>
            <ReadAloud id="res-safety" />
            <div className="res-grid">
              {SAFETY.map((c, i) => <ResCard key={i} card={c} />)}
            </div>
          </div>
        </section>

        <section className="res-section" aria-labelledby="veteran-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.veterans.eyebrow')}</p>
            <h2 id="veteran-orgs" className="serif res-cat-title">{t('res.cat.veterans.title')}</h2>
            <ReadAloud id="res-veterans" />
            <div className="res-grid">
              {VETERANS.map((c, i) => <ResCard key={i} card={c} />)}
            </div>
          </div>
        </section>

        <section className="res-section" aria-labelledby="lgbtq-orgs" data-readable>
          <div className="res-section-inner">
            <p className="eyebrow">{t('res.cat.lgbtq.eyebrow')}</p>
            <h2 id="lgbtq-orgs" className="serif res-cat-title">{t('res.cat.lgbtq.title')}</h2>
            <ReadAloud id="res-lgbtq" />
            <div className="res-grid">
              {LGBTQ.map((c, i) => <ResCard key={i} card={c} />)}
            </div>
          </div>
        </section>
